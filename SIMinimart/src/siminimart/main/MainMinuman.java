...
import siminimart.form.FormMinuman;

/**
 *
 * @author Ahmad Bagus Mas'udi
 */
public class MainMinuman extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        formMinuman1 = new siminimart.form.FormMinuman();
        ...
        jButton1.setBounds(790, 552, 110, 50);
        mainPanel.add(formMinuman1);
        formMinuman1.setBounds(0, 0, 985, 680);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int stokk = FormMinuman.Stok - FormMinuman.Jumlah;
        try {
            if (FormMinuman.Nama.equals("")) {
                JOptionPane.showMessageDialog(this, "Produk belum dipilih");
            } else if (FormMinuman.Stok <= 0) {
                JOptionPane.showMessageDialog(this, "Stok produk habis");
            } else {
                Connection con = connectionmysql.koneksiDB();
                String sql1 = "UPDATE databarang set stok = '" + stokk + "' WHERE kode_barang = '" + FormMinuman.Kode + "'";
                Statement S1 = con.createStatement();
                S1.execute(sql1);
                String sql = "INSERT INTO keranjang VALUES ('" + PanelLoginAndRegister.Name + "','" + FormMinuman.Kode + "','" + FormMinuman.Nama + "','" + stokk + "','" + FormMinuman.Harga + "','" + FormMinuman.Jumlah + "','" + FormMinuman.Totalharga + "')";
                Statement S = con.createStatement();
                S.execute(sql);
                JOptionPane.showMessageDialog(null, "Memasukkan ke keranjang berhasil");
                new MainMinuman().setVisible(false);
                new MainMinuman().setVisible(true);
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainMinuman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private siminimart.form.FormMinuman formMinuman1;

...
import siminimart.form.FormPemesanan;
...
public class MainPemesanan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        formPemesanan1 = new siminimart.form.FormPemesanan();
        ...
        LogOut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/siminimart/image/9.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/siminimart/image/trash-can (1).png"))); // NOI18N
        ...
        jButton1.setBounds(760, 270, 120, 40);
        mainPanel.add(formPemesanan1);
        formPemesanan1.setBounds(0, 0, 985, 680);

        panelBorder1.add(mainPanel);
        mainPanel.setBounds(220, 40, 985, 680);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            int stokk = FormPemesanan.Stok + FormPemesanan.Jumlah;
            String sql1 = "UPDATE databarang set stok = '"+ stokk + "' WHERE kode_barang = '" + FormPemesanan.Kode + "'";
            Statement S1 = con.createStatement();
            S1.execute(sql1);
            String sql = "DELETE FROM keranjang WHERE kode_barang = '" + FormPemesanan.Kode + "'";
    ...
    private siminimart.form.FormPemesanan formPemesanan1;

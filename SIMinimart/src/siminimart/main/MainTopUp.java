 ...
 */
public class MainTopUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        formTopUp1 = new siminimart.form.FormTopUp();
        ...
        mainPanel.add(formTopUp1, "card2");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainTopUp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private siminimart.form.FormTopUp formTopUp1;

...
import siminimart.swing.Button;
import siminimart.swing.MyPasswordField;
import siminimart.swing.MyTextField;
...
import siminimart.main.MainLogin;
...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private void initRegister() {
        ...
        txtUser.setPrefixIcon(new ImageIcon(getClass().getResource("/siminimart/image/user.png")));
        txtUser.setHint("Name");
        register.add(txtUser, "w 60%");
        MyPasswordField txtPass = new MyPasswordField();
        txtPass.setPrefixIcon(new ImageIcon(getClass().getResource("/siminimart/image/pass.png")));
        ...
        cmd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (txtUser.getText().equals("")) {
                    ...
                    try {
                        Connection con = connectionmysql.koneksiDB();
                        String sql = "INSERT INTO user(UserName, Password) VALUES ('" + txtUser.getText() + "','" + txtPass.getText() + "')";
                        Statement S = con.createStatement();
                        S.execute(sql);
                        JOptionPane.showMessageDialog(null, "Registrasi Berhasil");
                        String sql1 = "INSERT INTO saldo VALUES ('" + txtUser.getText() + "','0')";

...
public class FormMakanan extends javax.swing.JPanel {
    ...
    public void tampilkanMakanan() {
        ...
        try {
            ...
            String sql = "select * from databarang where `kategori` = 'Makanan'";
    ...
    private void txtJumlahKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtJumlahKeyReleased
        ...
        Totalharga = txtTotalHarga.getText();
            ...
            JOptionPane.showMessageDialog(this, "Melebihi Stok yang ada");
        }
    ...
    private void searchText1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchText1KeyReleased
       String cari = searchText1.getText();
        ...
        try {
            Connection con = connectionmysql.koneksiDB();
            String sql = "select * from databarang where `kategori` = 'Makanan' AND `nama_barang` LIKE '%" + cari+ "%'";
            Statement S = con.createStatement();
            ResultSet R = S.executeQuery(sql);
